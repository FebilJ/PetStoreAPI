...
public class ExtentListnerClass implements ITestListener{
	    ...
	    ExtentReports reports;				//common information like environment information
	    ExtentTest test;					//entries for test
	    
	    public void configureReport()
	    {
	        String timestamp = new SimpleDateFormat("yyyy.mm.dd.hh.mm.ss").format(new Date());
	        String reportName = "PetStoreAPITestReport-" + timestamp + ".html";
	        ...
	        reports.setSystemInfo("user name:", "febil");
